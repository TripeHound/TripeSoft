...
namespace Tests
{
	...
	public class PartitionTests
	{
		...
		#region Partion.MarkAssigned() tests
		[TestClass]
		public class MarkAssigned
		{
//			Partitioner.Partition unassigned = new Partitioner.Partition( 10, 90, Partitioner.Partition.States.Unassigned );
//			Partitioner.Partition  tentative = new Partitioner.Partition( 10, 90, Partitioner.Partition.States.Tentative );
//			Partitioner.Partition   assigned = new Partitioner.Partition( 10, 90, Partitioner.Partition.States.Assigned );
