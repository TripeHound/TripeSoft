...
namespace Tests
{
	...
	public class PartitionerTests
	{
		...
		public void TestContain()
		{
			...
			Assert.AreEqual		( null, partitioner.ContainingPartition(     -1 ), "Negative offset is contained" );
			...
			Assert.AreEqual		( null, partitioner.ContainingPartition( Size   ), "Overlarge offset is contained" );
		}
	}
}
